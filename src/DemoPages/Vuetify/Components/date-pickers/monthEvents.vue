<template>
  <v-layout justify-space-between wrap>
    <v-flex xs12 sm6 class="my-3">
      ...
      <v-date-picker v-model="date1" :events="arrayEvents"  event-color="green lighten-1" type="month"></v-date-picker>
    </v-flex>
    <v-flex xs12 sm6 class="my-3">
      <div class="subheading">Defined by function</div>
      <v-date-picker v-model="date2" :events="functionEvents" type="month"></v-date-picker>
    </v-flex>
  </v-layout>
</template>
