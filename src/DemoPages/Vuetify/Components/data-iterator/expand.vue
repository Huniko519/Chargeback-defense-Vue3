<template>
  <v-container fluid grid-list-md>
    ...
    <v-data-iterator :items="items" item-key="name" :rows-per-page-items="rowsPerPageItems"
      :pagination.sync="pagination" :expand="expand" row wrap>
      <template v-slot:item="props">
        <v-flex xs12 sm6 md4 lg3>
          <v-card>
            ...
            <v-switch v-model="props.expanded" :label="(props.expanded) ? 'Expanded' : 'Closed'" class="pl-3 mt-0"></v-switch>
            <v-divider></v-divider>
