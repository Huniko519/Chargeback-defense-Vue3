<template>
  <v-card flat color="transparent">
    ...
    <v-card-text>
      <v-slider v-model="value" step="10" ticks="always" tick-size="2"></v-slider>
    </v-card-text>

    <v-subheader>Tick labels</v-subheader>

    <v-card-text>
      <v-slider v-model="fruits" :tick-labels="ticksLabels" :max="3" step="1" ticks="always" tick-size="2"></v-slider>
    </v-card-text>
  </v-card>
</template>
