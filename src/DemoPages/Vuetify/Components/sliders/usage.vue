<template>
  <v-container fluid grid-list-lg>
    <v-layout row wrap>
      ...
      <v-flex xs12>
        <v-slider disabled label="Disabled" inverse-label value="30"></v-slider>
      </v-flex>

      <v-flex xs12>
        <v-slider label="Readonly" readonly value="30"></v-slider>
      </v-flex>
      ...
      <v-flex xs12>
        <v-slider v-model="slider" inverse-label label="Inverse label"></v-slider>
      </v-flex>

      <v-flex xs12>
        <v-slider v-model="volume" append-icon="volume_up" prepend-icon="volume_down"></v-slider>
      </v-flex>
