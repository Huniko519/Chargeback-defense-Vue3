  ...
  <div>
    ...
    <v-expansion-panel v-model="panel" :disabled="disabled" :readonly="readonly" expand>
      <v-expansion-panel-content disabled>
        ...
        <v-card>
          <v-card-text>Disabled content. Style is changed and user is unable to toggle content.</v-card-text>
        </v-card>
      ...
      <v-expansion-panel-content readonly>
        ...
        <v-card>
          <v-card-text>Readonly content. Style is unchanged but user is unable to toggle content.</v-card-text>
        </v-card>
      </v-expansion-panel-content>
