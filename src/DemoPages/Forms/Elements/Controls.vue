                ...
                <div class="card-body">
                  ...
                  <form class>
                    ...
                    <div class="position-relative form-group">
                      ...
                      <select multiplename="selectMulti" id="exampleSelectMulti" class="form-control">
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                        <option>4</option>
...
export default {
  ...
  data: () => ({
    ...
    subheading:
      "Wide selection of forms controls, using the Bootstrap 4 code base, but built with Vue.",
