      ...
      <div class="card-body">
        ...
        <b-row>
          <b-col md="4" class="py-4 text-center" v-for="placement in placements" :key="placement">
            ...
            <b-popover :target="'exPopover1-'+placement" :placement="placement" title="Popover!"
              triggers="hover focus" :content="`Placement ${placement}`">
            </b-popover>
          </b-col>
        </b-row>
      </div>
...
export default {
  ...
  data: () => ({
    ...
    subheading:
      "These Vue components are used to add interaction or extra information for your app's content.",
