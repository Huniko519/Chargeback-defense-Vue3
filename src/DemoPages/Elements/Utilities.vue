            ...
            <div class="table-wrap mt-40">
              <table class="table table-bordered mb-0">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code class="bg-transparent pa-0">class="h-[value]p"</code>
                    </td>
                    <td class="font-14">25 / 30 / 35 / 40 / 45 / 50 ... / 800 (step of 5)</td>
                  </tr>
                  <tr>
                    <td>
                      <code class="bg-transparent pa-0">class="mh-[value]p"</code>
                    </td>
                    <td class="font-14">
                  ...
                  <tr>
                    <td>
                      <code class="bg-transparent pa-0">class="mnh-[value]p"</code>
                    </td>
                    <td class="font-14">
                      100 / 125 / 150 / 200 / 225 ... / 800 (step of 25)
                      <br />Set
            ...
            <div class="table-wrap mt-40">
              <table class="table table-bordered mb-0">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code class="bg-transparent pa-0">class="h-[value]"</code>
                    </td>
                    <td class="font-14">25 / 30 / 35 / 40 / 45 / 50 ... / 100 (step of 5)</td>
                  </tr>
                  <tr>
                    <td>
                      <code class="bg-transparent pa-0">class="h-auto"</code>
                    </td>
                    <td class="font-14">Set the height to auto</td>
                  </tr>
                  <tr>
                    <td>
                      <code class="bg-transparent pa-0">class="mh-100"</code>
                    </td>
            ...
            <div class="table-wrap mt-40">
              <table class="table table-bordered mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <code class="bg-transparent pa-0">class="mw-[value]p"</code>
                    </td>
                    <td class="font-14">
                      25 / 50 / 75 / 100 / 125 / 150 / 200 / 225 ... / 800 (step of
                      25)
                      <br />Set max-width of an element
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <code class="bg-transparent pa-0">class="mnw-[value]p"</code>
                    </td>
                    <td class="font-14">
                      25 / 50 / 75 / 100 / 125 / 150 / 200 / 225 ... / 800 (step of
                      25)
                      <br />Set min-width of an element
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div class="table-wrap mt-40">
              <table class="table table-bordered mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <code class="bg-transparent pa-0">class="w-auto"</code>
                    </td>
                    <td class="font-14">Set the width to auto</td>
                  </tr>
                  <tr>
                    <td>
                      <code class="bg-transparent pa-0">class="mw-100"</code>
                    </td>
          ...
          <div class="col-sm">
            <div class="clearfix">
              <div class="d-inline-block float-left d-46 bg-light mr-5 mb-5">
                <div class="d-flex justify-content-center align-items-center w-100">d-46</div>
              </div>
              <div class="d-inline-block float-left d-74 bg-light mr-5 mb-5">
                <div class="d-flex justify-content-center align-items-center w-100">d-74</div>
              </div>
              <div class="d-inline-block float-left d-100 bg-light mr-5 mb-5">
                <div class="d-flex justify-content-center align-items-center w-100">d-100</div>
              </div>
            </div>
            <div class="table-wrap mt-40">
              <table class="table table-bordered mb-0">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code class="bg-transparent pa-0">class="d-[value]"</code>
                    </td>
