                      ...
                      <div class="widget-content-right">
                        <div class="widget-numbers text-primary">
                          <span class="count-up-wrapper">
                            <ICountUp :startVal="startVal" :endVal="endVal" :decimals="decimals"
                              :duration="duration" :options="options" @ready="onReady" />
                          </span>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="widget-content-right">
                        <div class="progress-circle-wrapper">
                          <div class="circle-progress">
                            <vue-circle :progress="50" :size="50" :reverse="false" line-cap="round" empty-fill="rgba(0, 0, 0, .1)"
                              :animation-start-value="0.0" :start-angle="0" insert-mode="append" :thickness="3" :show-percent="true">
                            </vue-circle>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="widget-content p-0">
                    <div class="widget-content-wrapper">
                      ...
                      <div class="widget-content-right">
                        <div class="progress-circle-wrapper">
                          <div class="circle-progress">
                            <vue-circle :progress="34" :size="54" :reverse="false" line-cap="round" :fill="fill"
                    ...
                    <div class="widget-content p-0">
                      <div class="widget-content-wrapper">
                        ...
                        <div class="widget-content-right">
                          <div class="progress-circle-wrapper">
                            <div class="circle-progress">
                              <vue-circle :progress="76" :size="50" :reverse="false" line-cap="round"
                                empty-fill="rgba(0, 0, 0, .1)" :animation-start-value="0.0" :start-angle="0"
                    ...
                    <div class="widget-content p-0">
                      <div class="widget-content-wrapper">
                        ...
                        <div class="widget-content-right">
                          <div class="progress-circle-wrapper">
                            <div class="circle-progress">
                              <vue-circle :progress="23" :size="45" :reverse="false" line-cap="round"
                                empty-fill="rgba(0, 0, 0, .15)" :animation-start-value="0.0" :start-angle="0"
                                insert-mode="append" :thickness="2" :show-percent="true">
                              </vue-circle>
                            </div>
                          </div>
                        </div>
