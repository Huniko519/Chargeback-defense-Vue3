      ...
      <div v-if="currentTab === 'tab1'">
          ...
          <div class="col-md-6">
            ...
            <div class="mb-3 text-white card-border bg-dark card">
              <div class="card-header">
                <i class="header-icon lnr-screen icon-gradient bg-warm-flame"></i>Without Shadow
            ...
            <div class="mb-3 card text-white bg-success">
              ...
              <div
                class="card-body"
              >With supporting text below as a natural lead-in to additional content.</div>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="main-card mb-3 card">
              <div class="card-header">
                <i class="header-icon lnr-gift icon-gradient bg-mixed-hopes"></i>Alternate Buttons
                <div class="btn-actions-pane-right actions-icon-btn">
                  <div role="group" class="btn-group-sm nav btn-group">
          ...
          <div class="col-md-4">
            <div class="main-card mb-3 card">
              <div class="card-body">
                ...
                <h6 class="card-subtitle">Card subtitle</h6>Some quick example text to build on the card title and make up the bulk of the card's content.
                <br />
                <br />
            ...
            <div class="main-card mb-3 card">
              <div class="card-body">
                <h5 class="card-title">Card Title</h5>This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.
                <br />
                <br />
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-shadow-primary border mb-3 card card-body border-primary">
              <h5 class="card-title">Primary Card Shadow</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-shadow-secondary border mb-3 card card-body border-secondary">
              <h5 class="card-title">Secondary Card Shadow</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-shadow-warning border mb-3 card card-body border-warning">
              <h5 class="card-title">Warning Card Shadow</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-shadow-danger border mb-3 card card-body border-danger">
              <h5 class="card-title">Danger Card Shadow</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-shadow-success border mb-3 card card-body border-success">
              <h5 class="card-title">Success Card Shadow</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-shadow-info border mb-3 card card-body border-info">
              <h5 class="card-title">Info Card Shadow</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-shadow-focus border mb-3 card card-body border-focus">
              <h5 class="card-title">Focus Card Shadow</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-shadow-alternate border mb-3 card card-body border-alternate">
              <h5 class="card-title">Alternate Card Shadow</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="mb-3 card text-white">
              <div class="card-img-overlay">
                <h5 class="text-white card-title">Card Title</h5>This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.
                <br />
                <br />
          ...
          <div class="col-md-4">
            <div class="card-border mb-3 card card-body border-primary">
              <h5 class="card-title">Primary Card Border</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-border mb-3 card card-body border-secondary">
              <h5 class="card-title">Secondary Card Border</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-border mb-3 card card-body border-warning">
              <h5 class="card-title">Warning Card Border</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-border mb-3 card card-body border-danger">
              <h5 class="card-title">Danger Card Border</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-border mb-3 card card-body border-success">
              <h5 class="card-title">Success Card Border</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-border mb-3 card card-body border-info">
              <h5 class="card-title">Info Card Border</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-border mb-3 card card-body border-focus">
              <h5 class="card-title">Focus Card Border</h5>With supporting text below as a natural lead-in to additional content.
            </div>
            <div class="card-border mb-3 card card-body border-alternate">
              <h5 class="card-title">Alternate Card Border</h5>With supporting text below as a natural lead-in to additional content.
            </div>
          </div>
          <div class="col-md-4">
            ...
            <div class="mb-3 card text-white card-body" style="background-color: rgb(51, 51, 51); border-color: rgb(51, 51, 51);">
              <h5 class="text-white card-title">Special Title Treatment</h5>With supporting text below as a
              natural lead-in to additional content.
            </div>
            <div class="mb-3 card text-white card-body bg-primary">
              <h5 class="text-white card-title">Special Title Treatment</h5>With supporting text below as a natural lead-in to additional content.
            </div>
